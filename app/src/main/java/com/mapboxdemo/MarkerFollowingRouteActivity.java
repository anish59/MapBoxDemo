...
public class MarkerFollowingRouteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_following_marker);
    ...
    private class DrawGeoJson extends AsyncTask<Void, Void, List<LatLng>> {
        ...
        protected void onPostExecute(final List<LatLng> points) {
            ...
            if (points.size() > 0) {
                ...
                Icon icon = IconFactory.getInstance(MarkerFollowingRouteActivity.this).fromResource(R.drawable.ic_directions_bike);
